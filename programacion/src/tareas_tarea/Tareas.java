...
public class Tareas {
	...
	/*
	 Propiedades de Clase:
		...
		listaDeTareas: Una lista que almacena las tareas pendientes.
	Funciones:
		agregarTarea(Tarea tarea): 
			Agrega una tarea a la lista de tareas.

		marcarTareaComoCompletada(int indice):
		 	Marca una tarea como completada según su índice en la lista.

		mostrarTareasPendientes():
		 	Muestra todas las tareas pendientes en la lista.

		mostrarTodasLasTareas():
		 	Muestra todas las tareas, tanto pendientes como completadas.
		
		eliminarTarea(int indice):
		 	Elimina una tarea específica de la lista de pendientes.
		
		mostrarTareasCompletadas(): 
			Muestra todas las tareas que han sido marcadas como completadas.
		
		contarTareasPendientes(): 
			Calcula el número total de tareas que aún están pendientes.
		
		obtenerTarea(int indice): 
			Obtiene una tarea específica por su índice en la lista.
